...
public class Hasil extends javax.swing.JFrame {
    ...
    public Hasil(Taillard taillard, int soalTerpilih) {
        ...
        tampung += "Total Makespan : " + makespan + "\n\n";
    ...
    private void inisialisasi() {
        ...
        for (int i = 0; i < this.taillard.getPemenangTiapSoal().length; i++) {
            model.addRow(new Object[] { i + 1, this.taillard.getBatasAtas()[i], this.taillard.getBatasBawah()[i],
                    this.taillard.getMakespanPemenang()[i], tampung[i] });
        }
    }
    ...
    // tampung += "Urutan job terbaik : \n";
    // for (int j = 0; j <
    // this.taillard.getPemenangTiapSoal()[0].getUrutanJob().length; j++) {
